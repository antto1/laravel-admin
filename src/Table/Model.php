...
class Model
{
    ...
    /**
     * Get the eloquent model of the table model.
     *
     * @return EloquentModel
     */
    ...
    protected function get()
    {
        ...
        throw new \Exception('Table query error');
    }
